...
mainEx05: matriz-operacoes-omp.c matrizv3.o multiplicacao_matriz.o multiplicacao_matriz_bloco.o timer.o
		$(CC) $(CCFLAGS) matriz-operacoes-omp.c matrizv3.o multiplicacao_matriz.o multiplicacao_matriz_bloco.o timer.o -o mainEx05 $(LDFLAGS) 
